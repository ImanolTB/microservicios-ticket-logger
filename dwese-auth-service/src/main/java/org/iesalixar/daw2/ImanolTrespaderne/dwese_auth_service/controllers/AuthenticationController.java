package org.iesalixar.daw2.ImanolTrespaderne.dwese_auth_service.controllers;

import jakarta.validation.Valid;
import org.iesalixar.daw2.ImanolTrespaderne.dwese_auth_service.dtos.AuthRequestDTO;
import org.iesalixar.daw2.ImanolTrespaderne.dwese_auth_service.dtos.AuthResponseDTO;
import org.iesalixar.daw2.ImanolTrespaderne.dwese_auth_service.utils.JwtUtil;
...
public class AuthenticationController {
    ...
    public ResponseEntity<AuthResponseDTO> authenticate(@Valid @RequestBody AuthRequestDTO authRequest){
      try {
          ...
          return ResponseEntity.ok(new AuthResponseDTO(token,"Authentication succefull"));
